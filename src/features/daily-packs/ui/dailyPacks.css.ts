...
export const dialogPanel = style({
  ...
  border: '1px solid rgba(255, 244, 215, 0.12)',
  background:
    'linear-gradient(180deg, rgba(14, 17, 30, 0.96) 0%, rgba(8, 10, 19, 0.98) 100%)',
...
export const dialogCardBody = style({
  ...
  background:
    'linear-gradient(180deg, rgba(15, 18, 31, 0.92) 0%, rgba(7, 10, 20, 0.98) 100%)',
})
...
globalStyle(`${dialogBackdrop}[data-revealed="true"] ${dialogCardSlot}[data-interactive="true"]:hover ${dialogCardButton}`, {
  transform: 'scale(1.08)',
  filter: 'brightness(1.04)',
})

globalStyle(`${dialogBackdrop}[data-revealed="true"] ${dialogCardSlot}[data-interactive="true"]:focus-within ${dialogCardButton}`, {
  transform: 'scale(1.08)',
  filter: 'brightness(1.04)',
})

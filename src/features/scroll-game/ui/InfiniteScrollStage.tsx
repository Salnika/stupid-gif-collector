...
import { MAX_ATTEMPTS, type RewardResult } from "../application/scrollRoundMachine";
...
export function InfiniteScrollStage() {
  ...
  const onUpdate = useCallback(
    (update: InfiniteScrollUpdate) => {
      ...
      stopTimerRef.current = restartTimeout(
  ...
  const handleCopyPopupShare = async () => {
    ...
    copyShareTimerRef.current = restartTimeout(
      copyShareTimerRef.current,
      () => {
